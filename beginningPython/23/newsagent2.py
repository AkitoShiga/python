...
class SimpleWebSource:
    ...
    """
    def __init__(self, url, title_pattern,
                 body_pattern, encoding='utf-8'):
        self.url = url
...
class PlainDestination:
    """
    すべてのニュース項目をプレーンテキストとして整形するニュース先
    """
...
def run_default_setup():
    ...
    clpa_group = 'comp.lang.pyton.announce'
    clpa_howmany = 3
